                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center w-75 m-auto">
                            <h4 class="text-dark-50 text-center mt-1 fw-bold">Change Password </h4>
                            <p class="text-muted mb-2">Enter your new password for change.</p>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="password" wire:model='confirm'
                                placeholder="Enter your password again">
                        </div>

                        <div class="mb-0 text-center">
                            <button class="btn btn-primary" wire:click='changePassword'>Chnage Password</button>
                        </div>
